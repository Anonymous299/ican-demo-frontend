...
const CurriculumManagement: React.FC = () => {
  ...
  const [activityForm, setActivityForm] = useState({
    name: '',
    activityType: 'Individual' as 'Individual' | 'Group' | 'Homework',
    gradingType: 'Marks' as 'Marks' | 'Rubric',
    description: '',
    materials: [''] 
  });
              ...
              <Card.Body>
                <VStack gap={6} align="stretch">
                  <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                    ...
                    <FormControl isRequired>
                      <FormLabel>Estimated Periods</FormLabel>
                      <Input
                        type="number"
                        min={1}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          const newActivity = {
                            ...
                            description: activityForm.description || 'Activity description',
                            materials: activityForm.materials.filter(m => m.trim()) || ['Materials needed']
                          };
                          setLessonForm(prev => ({
                            ...prev,
        ...
        {showLessonsModal && selectedPlan && (
          ...
          >
            <Card.Root maxW="6xl" w="95%" maxH="90vh" overflowY="auto">
              ...
              <Card.Footer>
                <Button w="100%" onClick={() => setShowLessonsModal(false)}>
                  Close
                </Button>
              </Card.Footer>
            </Card.Root>
